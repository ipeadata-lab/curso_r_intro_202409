...
Todos esses dados podem ser acessados diretamente no `storage6`, como visto na aula anterior. A maneira mais fácil de acessar esses dados é pelo pacote de R 
...
![](images/logo_ipeadatalake.png){width=300 fig-align="right"}
...
Dentre as colunas de dados espaciais, a coluna `Addr_type` é que traz informação sobre as categorias de precisão das coordenadas geográficas. [A definicao exata de cada categoria se encontra na documentacao do ArcGIS](https://pro.arcgis.com/en/pro-app/latest/help/data/geocoding/what-is-included-in-the-geocoded-results-.htm). Você deve ser muita cautela na hora de usar estes dados, e entender qual o grau de precisão mínimo que a sua análise exige.
:::
