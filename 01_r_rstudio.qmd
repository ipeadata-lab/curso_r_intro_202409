...
Além disso, a maioria dos pacotes vem com vignettes (tutoriais) que explicam como usá-los. Use a função `browseVignettes()` para listar as *vignettes* disponíveis para um pacote específico:
