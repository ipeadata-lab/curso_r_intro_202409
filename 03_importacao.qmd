...
- Projetos do RStudio (`.Rproj`) e diretórios

- Caminhos de arquivos
:::

O objetivo da etapa de importação é carregar a base de dados para a memória RAM. Assim conseguiremos utilizar os dados no R.
