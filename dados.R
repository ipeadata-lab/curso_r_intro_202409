...
dados_4092 |> 
  ...
  janitor::clean_names() |> 
  dplyr::rename(
    forca_trabalho_ocupacao_codigo = condicao_em_relacao_a_forca_de_trabalho_e_condicao_de_ocupacao_codigo,
    forca_trabalho_ocupacao = condicao_em_relacao_a_forca_de_trabalho_e_condicao_de_ocupacao
  ) |> 
  haven::write_dta("dados/sidrar_4092_bruto.dta")
