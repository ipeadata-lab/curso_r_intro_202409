...
- *Data summary*: informações gerais sobre a base de dados, como:  nome do objeto, número de linhas, número de colunas, quantas colunas temos em cada tipo, e se a base está agrupada por alguma variável[^nota-1].
...
[^nota-1]: Ainda não abordamos o conceito de grupos, então isso ficará mais claro posteriormente.
