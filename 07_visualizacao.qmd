...
1. Crie um gráfico de linhas para representar a evolução da taxa de desocupação ao longo do tempo para os estados da região Sul do Brasil, mas configure a escala do eixo x para que apareça as marcações dos anos. Isso ajudará a visualizar melhor a periodicidade dos dados.

::: {.callout-tip collapse="true"}
## Dica 1

Para configurar a escala do eixo x, utilize a função `scale_x_date()`. Consulte os argumentos da função.
:::
::: {.callout-tip collapse="true"}
## Dica 2
...
```{r}
#| label: exercicio-customizacao-1
#| echo: false
dados |> 
  filter(regiao == "Sul") |>
  ggplot() + 
