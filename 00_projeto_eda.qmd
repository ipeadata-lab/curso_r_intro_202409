...
1. **Crie um projeto no RStudio**: Crie um projeto no RStudio para armazenar os códigos e arquivos do projeto. Esse procedimento será descrito na aula [Conhecendo o R e o RStudio](01_r-rstudio.qmd). 
...
1. **Limpeza dos dados**: Utilize o que você aprendeu na etapa passada para limpar o conjunto de dados. Isso pode incluir lidar com dados ausentes, remover outliers ou inconsistências. A aula [Transformando dados](04_transformacao.qmd) será útil nessa etapa.

1. **Realize a análise exploratória de dados**: Utilize os conceitos apresentados no curso para realizar a análise exploratória de dados do conjunto escolhido. Lembre-se do objetivo que você definiu anteriormente e busque responder às perguntas que você levantou. Inclua gráficos e tabelas para apresentar os resultados e escreva suas interpretações ao longo do processo. As aulas [Analisando dados](05_analise.qmd) e [Visualizando dados](06_visualizacao.qmd) serão úteis nessa etapa.
