...
1. **Realize a análise exploratória de dados**: Utilize os conceitos apresentados no curso para realizar a análise exploratória de dados do conjunto escolhido. Lembre-se do objetivo que você definiu anteriormente e busque responder às perguntas que você levantou. Inclua gráficos e tabelas para apresentar os resultados e escreva suas interpretações ao longo do processo. As aulas [Análise exploratória de dados](06_analise_exploratoria.qmd) e [Visualizando dados](07_visualizacao.qmd) serão úteis nessa etapa.
